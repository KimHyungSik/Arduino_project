...
String cmd_get = "GET /data/2.5/weather?id=1832501&APPID=ef44abaa3200b2aabac5cc5677e40735&units=metric\r\n";
String recived = "";

String ssid = "\"B2\""; //WIFI ID
...
void loop() {
  ...
  AT_Object(Cipsend, 0);
  if (Serial3.find(">")) { //명령어 전송 준비
    Serial.println(">");
    recived = AT_Object(cmd_get, 4000); //API 가져오기
